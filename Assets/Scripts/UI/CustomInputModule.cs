using System;
//Я переделал StandartInputModule, чисто для того чтобы можно было в UI и джойстиком, и стрелочками двигаться нормально
namespace UnityEngine.EventSystems
{
    ...
    public class CustomInputModule : PointerInputModule
    {
        ...
        [SerializeField]
        private string m_HorizontalAxis2 = "HorizontalGamePadArrows";
        ...
        [SerializeField]
        private string m_VerticalAxis2 = "VerticalGamePadArrows";
        ...
        private bool AllowMoveEventProcessing(float time)
        {
            ...
            allow = Input.GetButtonDown(m_HorizontalAxis2);
            allow |= Input.GetButtonDown(m_VerticalAxis);
            allow |= Input.GetButtonDown(m_VerticalAxis2);
        ...
        private Vector2 GetRawMoveVector()
        {
            ...
            //это значит они будут усиливать друг друга, может надо чтоб перебивали?
